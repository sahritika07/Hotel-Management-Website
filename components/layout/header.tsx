...
//             <span className="text-xl md:text-2xl font-bold text-black">Elite Stay</span>
//           </Link>
      ...
      <div className="container mx-auto px-6 lg:px-8 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-3 lg:space-x-4">
            ...
            <Link href="/signup">
              <Button className="bg-yellow-500 text-black hover:bg-yellow-600 text-sm px-4 py-2">
                Register
              </Button>
            </Link>
          </div>
